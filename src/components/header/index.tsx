...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 left-0 z-40 w-full shadow-sm bg-background">
      <div className="container relative mx-auto flex min-h-20 flex-row items-center gap-4 lg:grid lg:grid-cols-3">
        ...
        <div className="flex w-full justify-end gap-4">
          <Button className="hidden md:inline" variant="light">
            <Link href="/contact">联系</Link>
          </Button>
          <div className="hidden border-r border-gray-200 md:inline" />
          <Button className="hidden md:inline" variant="light">
            <Link href={'/sign-in'}>
              登录
            </Link>
        ...
        <div className="flex w-12 shrink items-end justify-end lg:hidden">
          <Button onPress={() => setOpen(!isOpen)} variant="light">
